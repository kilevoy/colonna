// CommonJS test runner for purlin scenarios
const { runPurlinCalculation } = require('../src/calc/purlin/index.ts');
...
const scenarios = [
  ...
  },
  {
    ...
    input: {
      ...
      maxUtilization: "default",
      cassetteHeightFilter_mm: 0,
      prices: { "С255Б": 75000, "С355Б": 85000, "С245": 70000, "С345": 82000 },
    },
  },
  {
...
for (const sc of scenarios) {
  ...
  try {
    ...
    const firstSection = out.sections?.[0];
