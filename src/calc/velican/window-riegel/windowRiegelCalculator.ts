...
import { windowRiegelWorkbook } from './windowRiegelWorkbook.generated';
import type { ClimateSettlement, WindowRiegelInputs, WindowRiegelOption, WindowRiegelResult } from './windowRiegelTypes';
